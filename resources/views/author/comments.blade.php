        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    {{-- <span class="badge-info bg-blue">{{$comments->count()}}</span> --}}
                    </h2>
             ...
             {{-- here we used double foreach , beacuase $posts->comments will not work due to one to many relationship of post and comment 
                      [only one post have multiple comments so multipe posts will not working $posts->comment ] --}}
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            ...
                                            <p>{{$comment->comment}}</p>
                                            <a target="_blank" href="{{route('post.detailes',$comment->post->slug.'#comments')}}">Reply</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="media">
                                            <div class="media-right">
                                                <a target="_blank" href="{{route('post.detailes',$comment->post->slug)}}">
