                           ...
                           <tbody>
                               @foreach($popular_posts as $key => $post)
                                  ...
                                  <td>{{$key+1}}</td>
                                      ...
                                      <td>
                                      <a class="btn btn-primary waves-effect" target="_blank"  href="{{route('post.detailes',$post->slug)}}">View</a>
                                      </td>
                                  </tr> 
                               @endforeach
                           </tbody>
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-hover dashboard-task-infos">
                            ...
                            <tbody>
                                @foreach($active_authors as $key => $act)
                                    <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$act->name}}</td>
                                    <td>{{$act->posts_count}}</td>
                                    <td>{{$act->comments_count}}</td>            
                                    <td>{{$act->favourite_posts_count}}</td>            
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
