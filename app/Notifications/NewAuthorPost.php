...
class NewAuthorPost extends Notification implements ShouldQueue
{
     ...
     */
     ...
     //__construct function automatically run when a class is called
    public function __construct($post)
    {
        $this->post = $post;//$this->post=public $post & $post= __construct function $post
